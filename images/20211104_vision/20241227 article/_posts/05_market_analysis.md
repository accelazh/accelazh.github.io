...
关于市场的分析中，最核心的问题是，什么才是历久弥新的真正价值。这里的价值要求很高：

  * __溢价__：即使对手出售拥有同样功能集的产品，我们仍能卖出更高价格。

  * __难以复制__：即使技术完全泄露（或开源），我们的产品仍能卖出更高的价格。
...
广泛的连接让居中者成为 __中介__，往往比其连接的单个生产者更具优势，而 N 对 1 构成垄断优势。顺风时期，利用关系的弹性，快速扩展规模。面对风险时，中介方容易通过多重连接转嫁风险，而单一生产者则需刚性应对。中介方的优势并不依赖 __技术__ 获得，广泛的连接易于获取 __信息优势__，甚至能够通过与技术端的连接，分享其利润。遍身罗绮者，不是养蚕人；牲畜产肉奶，收获却是人。

对于人而言，在能够自由选择的情况下，关系的根本是 __信任__（Trust）。信任是 __资产__、是价值，需要时间积累，且随时间增值。
...
速度的英文 Velocity 更应景，指企业产品 __快速迭代__ 的能力。如果将产品的功能集比作城市建筑，那么速度类似 __高速公路__，虽然不对应直接产品功能，但对建设速度至关重要。
...
从系统开发角度，__成熟的 Continuous Integration（CI）系统__、全球协作、GitHub 颇具价值。这里可见为何 GitHub 被 Microsoft 收购。另一方面，2C 产品在迭代速度上，天然对 2B 产品具有优势，数据存储类产品尤其慢（数据不容损坏）。常见策略是，__用 2C 产品带动 2B__，例如，公有云供应商 Amazon、Google、Microsoft、Alibaba 都兼具两类产品。
...
个人开发者与体力劳动者的区别在于，__知识是资产__。知识能够提供额外工资回报，随着经验和更多知识的积累而增值，付出后可重复使用，并得到 __复杂性__ 的保护。知识容量可以获得三倍的增值，而很难想象体能运动获得三倍的性能提升，如 100 米短跑从 12 秒变成 4 秒。况且，体育竞赛只有一个冠军，其 “__内卷__” 比知识工作更为严苛。类似地，__996__ 式纯体力输出的工作方式并不明智，人难以每天工作三倍多的时间。
...
公司经营的重要一环是管理者，__管理者的工作本质是投资__，例如选择项目方向、雇用人员，对应的是工资的投资。管理者使用 __公司的资金__ 进行投资，从投资回报中支付自己的工资。相比个人开发者，管理者的工作天然具有 __多元化__，例如同时运作多个项目、孵化多个创新、雇佣多名员工。员工与管理者满足 N 对 1 的 __[关系](.)__，后者在风险中更加稳定，并可分发裁员名额。管理者并不直接依赖 __技术__ 获取竞争优势，但极具价值。

此外，许多工作岗位不具备资产的特性，却是社会运转的必要工作，献身其中的人是真正的 __勇士__。
...
也可看作排他式垄断、专利
从市场周期可以看到，技术脆弱的，在颠覆式创新下，几乎注定瓦解。
...
许多关于个人职业发展的讨论，见“资产”一节、前文

粉丝经济和仇恨资产、可持续战争，放到并列段落
不幸的是，社会仇恨具有良好的资产特性。人们为保卫生命而激发的杀戮欲望，远超对普通消费品的购买需求。地缘政治冲突的获利空间巨大，可持续战争光华毕现。


复杂性，从个人职业发展的知识可迁移性考虑如何？

职业发展：可迁移性，vs，在统一企业中深钻其复杂性。
